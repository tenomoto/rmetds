...
- [RColorBrewer](https://cran.r-project.org/web/packages/RColorBrewer/index.html)など、[様々なパレット](https://github.com/EmilHvitfeldt/r-color-palettes)がライブラリとして提供されています。
